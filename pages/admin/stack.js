    ...
    <>
      ...
      <div style={{ minHeight: '100vh', background: '#f8fafc', fontFamily: "'Outfit', sans-serif" }}>
        ...
        <header style={{
          ...
          <span style={{ fontSize: 14, fontWeight: 600, color: '#0f172a' }}>🧰 Stack</span>
        </header>
        ...
        <main style={{ maxWidth: 700, margin: '0 auto', padding: '48px 24px' }}>
          ...
          <div style={{
            ...
            <ul style={{ fontSize: 13, color: '#64748b', lineHeight: 2, paddingLeft: 20 }}>
              <li>
                <code style={{ fontSize: 12 }}>stack</code> array — each tool has{' '}
                <code style={{ fontSize: 12 }}>name</code>,{' '}
                <code style={{ fontSize: 12 }}>role</code>,{' '}
                <code style={{ fontSize: 12 }}>icon</code>,{' '}
                <code style={{ fontSize: 12 }}>what</code>,{' '}
                <code style={{ fontSize: 12 }}>howIUseIt</code>,{' '}
                <code style={{ fontSize: 12 }}>color</code>
              </li>
              <li>
                <code style={{ fontSize: 12 }}>lessons</code> array — builder lessons learned
              </li>
              <li>Principles section — the guiding philosophy for building with AI</li>
            </ul>
          </div>

          <a
            href="https://github.com/namosdev/nav.in/blob/main/pages/stack.js"
