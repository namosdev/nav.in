...
// ╔══════════════════════════════════════════════════╗
// ║  UPDATE THIS PAGE ONCE A MONTH — TAKES 10 MINS  ║
// ║  Just edit the `now` object below and push.     ║
// ╚══════════════════════════════════════════════════╝
        ...
        <div className="wrap">
          <div style={{ display:'grid', gridTemplateColumns:'1fr 1fr', gap:20 }}>
            ...
            <div className="glass reveal" style={{ padding:'36px 32px' }}>
              ...
              <p style={{ fontSize:14, color:'var(--text-muted)', lineHeight:1.75 }}>{now.reading.note}</p>
            </div>
            ...
            <div className="glass reveal" style={{ padding:'36px 32px' }}>
              ...
              <p style={{ fontFamily:'Cormorant Garamond, serif', fontSize:18, fontStyle:'italic', fontWeight:600, color:'var(--slate)', marginBottom:14, lineHeight:1.4 }}>
                &ldquo;{now.testing.hypothesis}&rdquo;
              </p>
              <p style={{ fontSize:13, color:'var(--text-muted)', lineHeight:1.75 }}>{now.testing.detail}</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="wrap">
          <div className="glass reveal" style={{
            ...
            <p style={{ fontFamily:'Cormorant Garamond, serif', fontSize:'clamp(20px,2.5vw,30px)', lineHeight:1.5, fontStyle:'italic', maxWidth:640, margin:'0 auto 28px', color:'var(--text)' }}>
              &ldquo;{now.currentQuestion}&rdquo;
            </p>
        ...
        <div className="wrap">
          <div className="reveal" style={{ padding:'28px 32px', borderRadius:16, background:'rgba(45,106,79,0.05)', border:'1px dashed rgba(45,106,79,0.2)' }}>
            ...
            <p style={{ fontSize:13, color:'var(--text-muted)', lineHeight:1.7 }}>
              To update this page: open <code style={{ background:'rgba(45,106,79,0.08)', padding:'2px 6px', borderRadius:4, fontFamily:'JetBrains Mono, monospace', fontSize:12 }}>pages/now.js</code> and edit the{' '}
              <code style={{ background:'rgba(45,106,79,0.08)', padding:'2px 6px', borderRadius:4, fontFamily:'JetBrains Mono, monospace', fontSize:12 }}>now</code> object at the top of the file.
              No design changes needed — just update the content. Push to GitHub → Vercel deploys automatically.
            </p>
          </div>
        </div>
      </section>
